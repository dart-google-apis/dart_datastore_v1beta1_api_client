part of datastore_v1beta1_api_console;

/** Client to access the datastore v1beta1 API */
/** API for accessing Google Cloud Datastore. */
class Datastore extends ConsoleClient {
  ...
  Datastore([oauth2.OAuth2Console auth]) : super(auth) {
